...
> - [`game-of-life`](https://github.com/CaliMark/game-of-life) — a second live example with attribution across **7 sources**: `opencode`, `devin`, `github-copilot`, `cline`, `cursor`, `gemini`, and a verified **human** edit at commit `b7e37f0` (100% human).
